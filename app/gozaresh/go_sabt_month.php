...
<div class="col-md-6 disp">
    <section class="panel ">
        <header style="padding-top:30px;margin: auto" class="panel-heading no-border ">
            گزارشگیری ماهانه ثبت نام ها&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo jdate('F - Y', time()); ?>
        </header>
        <table class="table table-bordered bod">
            ...
            $i = 0;
            $sum_mony = 0;
            $timnow = jdate('Y/F', time());
            foreach ($row as $show):
                $timdb = $show->tsabtname;
                $timdb = jdate('Y/F', $timdb);
                if ($timdb == $timnow):
                    $i++;
...
<div class="col-md-6 ">
    <section class="panel">
        ...
        foreach ($row as $show) {
            ...
            $timdb = jdate('Y/F', $timdb); //-------تبدیل زمان دیتا بیس به فرمت ماه و سال
        ...
        <table class="table table-bordered bod">
            ...
            if ($reshte=="r_1"){
                echo "<tr>
                        ...
                        <td>". $num1."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_1&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="فوتسال-مبتدی-68000"){
                echo "<tr>
                        <td> فوتسال . مبتدی </td>
                        <td>". $sum2."</td>
                        <td>". $num2."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_2&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="ژیمناستیک-پیشرفته-80000" ){
                echo "<tr>
                        <td>ژیمانستیک پیشرفته</td>
                        <td>". $sum3."</td>
                        <td>". $num3."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_3&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="کاراته-مبتدی-65000" ){
                echo "<tr>
                        <td>کاراته . مبتدی</td>
                        <td>". $sum4."</td>
                        <td>". $num4."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_4&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="تکواندو -مبتدی-60000"){
                echo "<tr>
                        <td>تکواندو . مبتدی</td>
                        <td>". $sum5."</td>
                        <td>". $num5."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_5&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="بوکس-مبتدی-65000"){
                echo "<tr>
                        <td>بوکس . مبتدی</td>
                        <td>". $sum6."</td>
                        <td>". $num6."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_6&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="کیک بوکس-مبتدی-65000"){
                echo "<tr>
                        <td>کیک بوکس . مبتدی</td>
                        <td>". $sum7."</td>
                        <td>". $num7."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_7&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="پارکور-مبتدی-65000"){
                echo "<tr>
                        <td>پارکور . مبتدی</td>
                        <td>". $sum8."</td>
                        <td>". $num8."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_8&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="کنگ فو-مبتدی-60000"){
                echo "<tr>
                        <td>کونگ فو . مبتدی</td>
                        <td>". $sum9."</td>
                        <td>". $num9."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_9&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="کشتی ازاد-بزرگسالان-70000"){
                echo "<tr>
                        <td>کشتی ازاد بزرگسالان . مبتدی</td>
                        <td>". $sum10."</td>
                        <td>". $num10."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_10&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="کشتی ازاد-نوجوانان-60000"){
                echo "<tr>
                        <td>کشتی ازاد نوجوانان . مبتدی</td>
                        <td>". $sum11."</td>
                        <td>". $num11."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_11&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="ژیمناستیک-مبتدی-65000"){
                echo "<tr>
                        <td>ژیمناستیک  . مبتدی</td>
                        <td>". $sum12."</td>
                        <td>". $num12."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_12&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="والیبال-پیشرفته-65000"){
                echo "<tr>
                        ...
                        <td>". $num13."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_13&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="بدنسازی-هرروز-85000"){
                echo "<tr>
                        <td>بدنسازی . هرروز</td>
                        <td>". $sum14."</td>
                        <td>". $num14."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_14&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="بدنسازی-یک روز در میان-60000"){
                echo "<tr>
                        ...
                        <td>". $num15."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_15&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="بدنسازی-جلسه ای-10000"){
                echo "<tr>
                        ...
                        <td>". $num16."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_16&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="ایروبیک-مبتدی-40000"){
                echo "<tr>
                        <td>ایروبیک . مبتدی</td>
                        <td>". $sum17."</td>
                        <td>". $num17."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_17&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="صبح-ژیمناستیک-65000"){
                echo "<tr>
                        ...
                        <td>". $num18."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_18&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="صبح-ژیمناستیک-80000"){
                echo "<tr>
                        ...
                        <td>". $num19."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_19&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="صبح-والیبال-65000"){
                echo "<tr>
                        ...
                        <td>". $num20."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_20&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="صبح-والیبال-90000"){
                echo "<tr>
                        ...
                        <td>". $num21."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_21&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="صبح-فوتسال-68000"){
                echo "<tr>
                        ...
                        <td>". $num22."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_22&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="ژیمناستیک-مبتدی-حسینی"){
                echo "<tr>
                        ...
                        <td>". $num111."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_111&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="ژیمناستیک-مبتدی-کولیوند"){
                echo "<tr>
                        ...
                        <td>". $num112."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_112&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="والیبال-مبتدی-50000"){
                echo "<tr>
                        ...
                        <td>". $num113."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_113&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="تکواندو -مبتدی-50000"){
                echo "<tr>
                        ...
                        <td>". $num114."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_114&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="کاراته-مبتدی-50000"){
                echo "<tr>
                        ...
                        <td>". $num115."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_115&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="ژیمناستیک-پیشرفته-"){
                echo "<tr>
                        ...
                        <td>". $num116."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_116&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="70000-پیلاتس-مبتدی"){
                echo "<tr>
                        ...
                        <td>". $num117."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_117&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="ایروبیک-مبتدی"){
                echo "<tr>
                        ...
                        <td>". $num118."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_118&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="بدنسازی-یک روز در میان-60000"){
                echo "<tr>
                        ...
                        <td>". $num119."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_119&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="بدنسازی-جلسه ای-10000"){
                echo "<tr>
                        ...
                        <td>". $num120."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_120&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="فوتسال-مبتدی-70000"){
                echo "<tr>
                        ...
                        <td>". $num122."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_122&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="رقص-مبتدی-65000"){
                echo "<tr>
                        ...
                        <td>". $num123."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_123&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
            ...
            if ($reshte=="هاپکیدو-مبتدی-70000"){
                echo "<tr>
                        ...
                        <td>". $num124."</td>
						 <td>
						     <a class=\"btn btn-info\" href=\"dashbord.php?contact=joziat&tbl=r_124&vas=sabt&tim=month\" >نمایش</a>
					</td>
                  </tr>"; }            //---------پایان ایتم جدول
